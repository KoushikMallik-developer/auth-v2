...
from api.models.response_data_types.seller_details import SellerDetailsResponseData
...
class SellerDetailView(APIView):
    ...
    @extend_schema(responses={200: SellerDetailsResponseData})
        ...
        try:
            ...
            if validate_user_uid(uid=user_id).is_validated:
                if is_seller_account(uid=user_id):
                    ...
                    data = SellerDetailsResponseData(
